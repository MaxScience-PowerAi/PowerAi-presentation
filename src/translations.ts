export const translations = {
  fr: {
    header: {
      title: "Rapport PowerAi Interactif",
      aiAssistant: "Assistant IA",
      scrollInfo: "Faites défiler pour voir tout le rapport"
    },
    chat: {
      welcome: "Bonjour ! Je suis l'assistant IA de PowerAi. Comment puis-je vous aider avec votre rapport aujourd'hui ?",
    ...
    report: {
      cover: {
        ...
        title1: "L'avenir de",
        title2: "l'IA au 237",
        desc: "Stratégie de déploiement, services B2B et démocratisation de l'intelligence artificielle au Cameroun.",
        founders: "Fondateurs",
      ...
      section4: {
        ...
        mainText: "Notre approche lors des rendez-vous ne consiste pas à \"chercher de l'argent\", mais à comprendre les besoins réels.",
        trustTitle: "Confiance",
        trustDesc: "Construire une relation stable avant de parler collaboration.",
        potentialTitle: "Potentiel",
        potentialDesc: "Montrer notre sérieux et la scalabilité de nos solutions.",
        footerTag: "Document de Base Stratégique"
      }
    }
  },
  en: {
    header: {
      title: "Interactive PowerAi Report",
      aiAssistant: "AI Assistant",
      scrollInfo: "Scroll down to see the full report"
    },
    chat: {
      welcome: "Hello! I am the PowerAi AI assistant. How can I help you with your report today?",
    ...
    report: {
      cover: {
        ...
        title2: "AI in 237",
        desc: "Deployment strategy, B2B services, and democratization of artificial intelligence in Cameroon.",
        founders: "Founders",
      ...
      section4: {
        ...
        mainText: "Our approach during meetings is not to \"look for money,\" but to understand real needs.",
        trustTitle: "Trust",
        trustDesc: "Build a stable relationship before discussing collaboration.",
        potentialTitle: "Potential",
        potentialDesc: "Show our seriousness and the scalability of our solutions.",
        footerTag: "Strategic Base Document"
      }
    }
  }
};
